    ...
    DroppableArea =
        function (n) {
            ...
            this.render = function () {
                ...
                if (_Templatetor.templatable(result))
                    result = new _Templatetor().setTemplate(result).render();
                _StepInvoker.addSource('/javascripts/jtrainer/current/js/additions/drag-drops.js').addCommand('makeDroppable', this.getName());
                return result;
            };
        };
    ...
    DraggableGroup =
        function (n) {
            ...
            this.render = function () {
                ...
                if (_Templatetor.templatable(result))
                    result = new _Templatetor().setTemplate(result).render();
                _StepInvoker.addSource('/javascripts/jtrainer/current/js/additions/drag-drops.js').addCommand('makeDraggable', this.getName());
                return result;
            };
        };
